        ...
        init: function( options ) {
            ...
            return this.each( function() {
                ...
                var handlemove = function(e) {
					...
					//console.log(newval,dr,radius,increments)
                    ...
                    if ( data.activedata.data ) {
                        var pp = newval - data.activedata.data[activedrag];
						var kk=0;
                        if(pp>0)
							kk=1;
						if(pp<0)
						...
						while(pp!=0)
						{
							for (i = 0; i <  data.activedata.data.length; i++) { 
							
							if(pp<0)
							{
								if((i!=activedrag)&&(data.activedata.data[i]<100))
								{
									 data.activedata.data[i]=data.activedata.data[i]-kk;
									 console.log(pp+' '+i);
								if(pp<0)
									pp=pp+1;
								if(pp==0)
							...
							if(pp>0)
							{
								if((i!=activedrag)&&(data.activedata.data[i]>0))
								{
									 data.activedata.data[i]=data.activedata.data[i]-kk;
									 console.log(pp+' '+i);
